...
if not imguicheck or not sampevcheck or not encodingcheck or not lfscheck or not monetluacheck or not doesFileExist('moonloader/Med Helper/Images/MedH_Images.png') then
	function main()
		...
		sampAddChatMessage(('[MedHelper]{EBEBEB} Íà÷àëîñü ñêà÷èâàíèå íåîáõîäèìûõ ôàéëîâ. Åñëè ñêà÷èâàíèå íå óäàñòñÿ, òî îáðàòèòåñü ê {FF33F2}vk.com/Zorahm{ebebeb}.'),0xFF33F2)
				...
				elseif mainwindow[0] == 3 then
					...
					elseif infowindow[0] == 2 then
						...
						imgui.BeginGroup()
							...
							imgui.PushFont(font[15])
							imgui.TextColoredRGB('Àâòîð - {MC}Zorahm')
							imgui.TextColoredRGB('Àâòîð ñòàðîãî ñêðèïòà - {MC}EvilDucky')
...
function sampev.onShowDialog(dialogId, style, title, button1, button2, text)
	...
	elseif dialogId == 235 and getmyrank then
		if find(text, 'Áîëüíèöà') then
			...
			MedHelperMessage('Âû íå ðàáîòàåòå â áîëüíèöå, ñêðèïò âûãðóæåí! Åñëè ýòî îøèáêà, òî îáðàòèòåñü ê {MC}vk.com/zorahm{WC}.')
			NoErrors = true
			thisScript():unload()
		end
...
5. Åñëè äàæå ýòî íå ïîìîãëî Âàì, òî îòïðàâüòå àâòîðó {2594CC}(vk.com/zorahm){FF33F2} ñêðèíøîò îøèáêè.{FFFFFF}

...
function main()
	...
	sampRegisterChatCommand('heal', function(param)
		...
		return sendchatarray(configuration.main_settings.playcd, {
			...
			{'/me îòêðûâ ñóìêó, äîñòàë{gender:äîñòàë|äîñòàëà} íåîáõîäèìîå ëåêàðñòâî è ïåðåäàë{gender:ïåðåäàë|ïåðåäàëà} ÷åëîâåêó íàïðîòèâ'},
	...
	sampRegisterChatCommand('cure', function(param)
		...
		return sendchatarray(configuration.main_settings.playcd, {
			{'/me ëåãêèì äâèæåíèåì ðóêè îòêðûë{gender:îòêðûë|îòêðûëà} ìåä. ñóìêó, ïîñëå ÷åãî {gender:äîñòàë|äîñòàëà} ïëàòîê'},
			{'/me àêêóðàòíî ïðèëîæèë{gender:ïðèëîæèë|ïðèëîæèëà} ïëàòîê êî ðòó ïîñòðàäàâøåãî, ïîñëå ÷åãî {gender:ñäåëàë|ñäåëàëà} ãëóáîêèé âäîõ'},
			{'/do Â ë¸ãêèõ ìíîãî âîçäóõà.'},
			{'/me {gender:âñòàë|âñòàëà} íà êîëåíè, ïîñëå ÷åãî {gender:ïðèñëîíèë|ïðèñëîíèëàñü} ê ïàöèåíòó'},
			{'/me {gender:ïîäâåë|ïîäâåëà} ãóáû êî ðòó ïîñòðàäàâøåãî, ïîñëå ÷åãî {gender:íà÷àë|íà÷àëà} äåëàòü èñêóññòâåííîå äûõàíèå'},
			{'/me {gender:îòâåë|îòâåëà} ãóáû îò ðòà ïîñòðàäàâøåãî, ïîñëå ÷åãî {gender:ñäåëàë|ñäåëàëà} ãëóáîêèé âäîõ'},
			{'/me {gender:ïîäâåë|ïîäâåëà} ãóáû êî ðòó ïîñòðàäàâøåãî, ïîñëå ÷åãî {gender:íà÷àë|íà÷àëà} äåëàòü èñêóññòâåííîå äûõàíèå'},
			{'/todo Ñåé÷àñ àêêóðàòíî ïîäíèìàéòåñü*ïîìîãàÿ ÷åëîâåêó âñòàòü'},
			{'/cure %s',param},
		})
	end)
...
changelog = {
 ...
 - Óáðàíà ñèñòåìà âàêöèíàöèè îò êîðîíàâèðóñà]]
		...
		
		{
			...
			date = '02.05.2024',
			text = {
				'Óâåëè÷åíî îêíî ñàìîãî ñêðèïòà',
				'Ñìåíà àâòîðà ñêðèïòà',
			},
			patches = {
				active = false,
				text = [[
 - ÏÎËÍÎÑÒÜÞ Óáðàíà ñèñòåìà âàêöèíàöèè îò êîðîíàâèðóñà]]
			},
		},
		
 		{
			...
			date = '02.05.2024',
			text = {
				'Èçìåíåíà îòûãðîâêà /heal',
				'Èçìåíåíà îòûãðîâêà /cure',
			},
			patches = {
				active = false,
				text = [[
 - Íè÷åãî]]
		 		...
		 		
		{
			...
			date = '12.05.2024',
			text = {
				'Óâåëè÷åíî îêíî "Ìåíþ áûñòðîãî äîñòóïà"',
				'ñïðàâëåí áàã ñ íåðàáîòàþùåé êíîïêîé Âûëå÷èòü èãðîêà',
			},
			patches = {
				active = false,
				text = [[
